...
const exhibits = [
  {
    id: "blonkino", name: 'Blokinos',
    area: "desert", keeper: '@rob',
    description: [
      "The aptly named blonkino is a known for its distinctive shape.  Aple to blend into desert discarded, the blokino is a skilled hunter, capable of catching a baby emu in flight. These dully colored mammal-reptiles make their nests in used Amazon shipping boxes and live their lives in small colonies of up to 100 individuals. As seen here, blokinos are very family oriented and love to pose for photos.",
